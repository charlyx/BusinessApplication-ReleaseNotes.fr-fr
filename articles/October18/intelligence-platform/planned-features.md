...
|----------|---------------|------------------------|
|**Accessibilité : slicers** : Les utilisateurs finaux peuvent utiliser un clavier pour interagir avec des slicers   |Disponibilité générale   |Octobre 2018    |
|**Mise en correspondance flexible dans les Q&R** : De meilleurs résultats aux Q&R lorsqu'un utilisateur épelle mal des mots en posant une question   |Disponibilité générale   |Octobre 2018    |
|[Mise en forme basée sur une expression](power-bi-desktop/expression-based-formatting.md)   |Disponibilité générale   |Octobre 2018    |
|[Afficher les mesures en tant qu'URL interactives](power-bi-desktop/show-measures-clickable-urls.md)   |Disponibilité générale   |Octobre 2018    |
|[Création de thèmes au-dessus du niveau de rapport et styles de conteneur visuels](power-bi-desktop/theming-over-report-level-visual-container-styles.md)   |Disponibilité générale   |Octobre 2018    |
|[Disponibilité générale des thèmes](power-bi-desktop/theming-general-availability.md)   |Disponibilité générale   |Octobre 2018    |
...
|[Quick Insights supplémentaires](power-bi-desktop/additional-quick-insights.md)   |Version préliminaire publique   |Octobre 2018    |
|[Agrégations](power-bi-desktop/aggregations.md)   |Version préliminaire publique   |Octobre 2018    |
|[Modèles composites](power-bi-desktop/composite-models.md)   |Version préliminaire publique   |Octobre 2018    |
|[Copier des données à partir des visuels de table et de matrice](power-bi-desktop/copy-cell-data.md)   |Version préliminaire publique   |Octobre 2018    |
...
|[Pipeline de télémétrie des Q&R](power-bi-desktop/qna-telemetry-pipeline.md)   |Version préliminaire publique   |Octobre 2018    |
...
|[Papiers peints des rapports](power-bi-desktop/report-wallpapers.md)   |Version préliminaire publique   |Octobre 2018    |
...
|[Préparation de données en libre-service avec des flux de données](power-bi-service/self-service-data-prep-with-dataflows.md)   |Disponibilité générale   |Octobre 2018    |
...
|[Mesures de capacité historique (Power BI Premium)](power-bi-service/historical-capacity-metrics.md)   |Disponibilité générale   |Octobre 2018    |
|[Intégration à Azure](power-bi-service/azure-integration.md)   |Version préliminaire publique   |Octobre 2018    |
...
|[Point de terminaison XMLA pour la connectivité client et la gestion de cycle de vie tierces (Power BI Premium)](power-bi-service/xmla-endpoint.md)   |Version préliminaire publique   |Octobre 2018    |
...
|[Rapports paginés](power-bi-mobile/power-bi-paginated-reports-available-mobile.md)   |Version préliminaire publique   |Octobre 2018    |
...
|[Expérience de page d'accueil personnalisée](power-bi-mobile/personalized-home-experience.md)   |Version préliminaire publique   |Octobre 2018    |
...
|Fonctionnalité   |Type de version   |Mois de la version cible    |
|----------|---------------|------------------------|
|[API pour gérer et intégrer les applications Power BI](power-bi-apps/apis-manage-embed-power-bi-apps.md)   |Disponibilité générale   |Octobre 2018    |
|[Intégration de contenu Power BI à partir d'applications Power BI](power-bi-apps/embedding-power-bi-content-power-bi-apps.md)   |Disponibilité générale   |Octobre 2018    |
|[Installation d'applications Power BI](power-bi-apps/installing-power-bi-apps.md)   |Disponibilité générale   |Octobre 2018    |
|[Application des licences pour les applications Power BI](power-bi-apps/licensing-enforcement-power-bi-apps.md)   |Disponibilité générale   |Octobre 2018    |
|[Personnalisation](power-bi-apps/personalization.md)   |Disponibilité générale   |Octobre 2018    |
|[Créer un package d'application Power BI](power-bi-apps/create-app-package.md)   |Disponibilité générale   |Octobre 2018    |
|[Prise en charge d'ECMAScript](power-bi-apps/ecmasscript.md)   |Disponibilité générale   |Octobre 2018    |
|[Mettre à jour une application existante](power-bi-apps/update-existing-app.md)   |Disponibilité générale   |Octobre 2018    |
...
|[Visuels personnalisés dans Excel](power-bi-custom-visuals/custom-visuals-excel-preview.md)   |Version préliminaire publique   |Octobre 2018    |
