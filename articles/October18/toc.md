...
### [Contenu vidéo à l'aide de Microsoft Stream](dynamics365-marketing/marketing/video-content-using-stream.md)
...
#### [Résumé des nouveautés](service/customer-service-omni-channel-release-notes/index.md)
...
#### [Mises à jour de la facilité d'utilisation et de la productivité](dynamics365-finance-operations/usability-productivity.md)
...
#### [Fonctionnalité de formulaires SharePoint améliorée](powerapps/enhanced-sharepoint-forms-functionality.md)
...
#### [Améliorations du partage](powerapps/sharing-enhancements.md)
...
#### [Les rapports Reporting Services dans Dynamics 365 sont désormais accessibles](powerapps/reporting-services-reports-in-dynamics-365-are-now-accessible.md)
...
#### [Améliorations des vues cumulatives dans Common Data Service pour les applications](powerapps/enhancements-to-roll-up-views-in-common-data-service.md)
#### [Client Outlook v8.2 plus fiable pour Common Data Service pour les applications](powerapps/more-reliable-outlook-client-v8.2-for-common-data-service.md)
#### [Client Outlook v9.0 plus fiable pour Common Data Service pour les applications](powerapps/more-reliable-outlook-client-v9.0-for-common-data-service.md)
...
#### [Prise en charge des utilisateurs délégués dans Common Data Service pour les applications](powerapps/support-for-delegate-users-in-common-data-service.md)
...
#### [Déploiement de bout en bout automatique des solutions Power BI Embedded](intelligence-platform/power-bi-embedded/automatic-end-end-deployment-pbi-embedded-solutions.md)
#### [Déployer un tableau de bord ou une vignette mis à jour dans l'environnement de production](intelligence-platform/power-bi-embedded/deploy-updated-dashboard-or-tile-production.md)
#### [Enregistrement des erreurs](intelligence-platform/power-bi-embedded/enable-developers-troubleshoot.md)
#### [Amélioration des API d'actualisation](intelligence-platform/power-bi-embedded/improved-refresh-apis.md)
